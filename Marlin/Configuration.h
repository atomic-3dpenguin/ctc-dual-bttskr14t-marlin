...
#define STRING_CONFIG_H_AUTHOR "(Atomic-3DPenguin, AP-MK2)" // Who made the changes.
...
#define DEFAULT_bedKp 63.79
#define DEFAULT_bedKi 9.37
#define DEFAULT_bedKd 289.69
